...
import numpy as np
from audioldm.modules.diffusionmodules.ema import *

from torch.optim.lr_scheduler import LambdaLR
from audioldm.modules.diffusionmodules.model import Encoder, Decoder
...
class AutoencoderKL(pl.LightningModule):
    ...
    def decode_to_waveform(self, dec):
        from audioldm.utilities.model_util import vocoder_infer
