...
import audioldm_finetuned.modules.audiomae.models_vit as models_vit
import audioldm_finetuned.modules.audiomae.models_mae as models_mae
...
class Vanilla_AudioMAE(nn.Module):
    """Audio Masked Autoencoder (MAE) pre-trained on AudioSet (for audioldm_finetuned)"""
